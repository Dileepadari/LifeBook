...
//
// GitHub has no theme toggle, so the toggle is a pair of pages linking to each
// other. They have to stay identical apart from the screenshot paths and that
// one link, which is why the light page is generated rather than maintained:
// edit README.md, run this, commit both.
...
process.stdout.write(`Wrote ${path.relative(ROOT, OUT)} from ${path.relative(ROOT, SRC)}\n`);
